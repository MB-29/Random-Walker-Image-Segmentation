...
seeds_file_path = os.path.join('input','chien', 'chien_25_seeds.pickle')

image_path = os.path.join('input','chien.jpg')
...
for beta in betas_list:
    ...
    correct_segmentation_path = 'input/chien/chien_got.png'
